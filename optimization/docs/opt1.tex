...
\end{align}
    ...
    \begin{align}
	\label{eq:vol_varx}
	f(x) = \sqrt{2(\lambda^2+2\lambda+2)}
\end{align}
\begin{align}   
    f'(x) = \frac{2(\lambda+1)}{\sqrt{2(\lambda^2+2\lambda+2)}}
	\end{align}
...
\vspace{1mm}
\begin{equation}
\implies x_{n+1}=x_n+\alpha\frac{2(\lambda+1)}{\sqrt{2(\lambda^2+2\lambda+2)}}
\end{equation}
